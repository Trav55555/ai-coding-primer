			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: 'IDE References', items: [{ autogenerate: { directory: 'tools/ides' } }] },
						{
							label: 'Extension References',
							items: [{ autogenerate: { directory: 'tools/extensions' } }],
						},
						{ label: 'CLI References', items: [{ autogenerate: { directory: 'tools/cli' } }] },
						{
