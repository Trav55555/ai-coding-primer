...
2. **Check whether a narrower workflow works.** Use [Choose a Workflow and Stack](/ai-coding-primer/learn/beginner/choose-your-tool/) before accepting platform complexity.
...
- [Choose a Workflow and Stack](/ai-coding-primer/learn/beginner/choose-your-tool/) for deciding whether an agent platform is necessary
