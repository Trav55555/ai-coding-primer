...
- a SaaS hype page
- an AI-bro tool directory
- an academic whitepaper
...
Prioritize readable long-form documentation, strong contrast, keyboard navigation, reduced-motion friendliness, and no color-only meaning.

Avoid dense comparison tables where prose or decision trees would be clearer. When tables are useful, keep them scannable and supported by plain-language interpretation.
